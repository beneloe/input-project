...
u1 = User(id = 1,  username = "hungry1", email = "hungry@user.com", order_id = o1.id)
u2 = User(id = 2,  username = "hungry2", email = "hungry2@user.com", order_id = o2.id)
u3 = User(id = 3,  username = "hungry3", email = "hungry3@user.com", order_id = o3.id)
u4 = User(id = 4,  username = "hungry4", email = "hungry4@user.com", order_id = o4.id)
